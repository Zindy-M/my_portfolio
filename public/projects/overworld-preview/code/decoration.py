...
class Sky:
	def __init__(self,horizon,style = 'level'):
		...
		self.top = pygame.image.load(os.path.join(current_dir, '../graphics/decoration/sky/sky_top.png')).convert()
		self.bottom = pygame.image.load(os.path.join(current_dir, '../graphics/decoration/sky/sky_bottom.png')).convert()
		self.middle = pygame.image.load(os.path.join(current_dir, '../graphics/decoration/sky/sky_middle.png')).convert()
